...
##################################################################################################################
### FUNCTION TO ESTIMATE TRHOUGH OF SEASONALITY.
### Adapted from function to estimate minimum the minimum mortality temperature by Tobías et al. 2017. 
### https://pubmed.ncbi.nlm.nih.gov/27748681/
### findmax.R
##################################################################################################################
##################################################################################################################
