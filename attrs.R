...
##################################################################################################################
### FUNCTION TO ESTIMATE ATTRIBUTABLE FRACTION.
### Adapted from function to estimate attributable measures from DLNM by Gasparrini and Leone 2014. 
### https://pubmed.ncbi.nlm.nih.gov/24758509/
### attrs.R
##################################################################################################################
##################################################################################################################
